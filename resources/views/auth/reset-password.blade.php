...
<head>
    ...
    <title>Set New Password — Planora</title>
            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $email) }}" required autofocus placeholder="you@example.com" autocomplete="email">
                    </div>

                    <div class="input-group">
                        <label for="password">New password</label>
                        <div style="position:relative;">
                            <input type="password" name="password" id="password" required placeholder="Enter new password" autocomplete="new-password">
                    ...
                    <div class="input-group">
                        ...
                        <div style="position:relative;">
                            <input type="password" name="password_confirmation" id="password_confirmation" required placeholder="Confirm new password" autocomplete="new-password">
                            <button type="button" class="toggle-pw" onclick="togglePassword('password_confirmation', this)" aria-label="Toggle password visibility">
                                👁️
                            </button>
                        </div>
                    </div>
